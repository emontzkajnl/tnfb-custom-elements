...
class Td_block_21 extends Tnfb_Block_Class {

    protected $tag = 'td_block_21';

// post id, categories, tag slug, post number, custom title, title url, 

    public function map() {
        return array(
            'name'        => esc_html__( 'td_block_21', 'text-domain' ),
            'description' => esc_html__( 'td_block_21', 'text-domain' ),
            'base'        => 'vc_infobox',
